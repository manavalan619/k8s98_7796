...
DESKTOPCODE='../../../application/client/desktop/k8s98_7796'
DESKTOPIMAGENAME='geppettotest/k8s98_7796-desktop:1.0'
...
helm install --name k8s98_7796 ./helm
if [ $? -eq 0 ]; then
